...
import server.service.MailSchedule2;
...
public class Server {
    ...
    public static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Server.class);
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            scheduledExecutorService.scheduleAtFixedRate(new MailSchedule2(),0,1,TimeUnit.HOURS);
        }catch(Exception e){
